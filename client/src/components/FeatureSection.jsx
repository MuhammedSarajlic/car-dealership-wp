      ...
      <div className="px-150 w-full h-453 my-100">
        <div className="bg-white w-full h-full flex">
          <Link className="w-1/3 h-453 bg-mainColor mr-15 rounded-xl overflow-hidden">
            <img src={f_img1} alt="feature-img" className="h-1/2 w-full" />
            <div className="h-1/2 p-17">
              <p className="text-white text-xl mb-10">
                BMW M4 CS M-PERFORMANCE/ CARBON/LED/KAMERA/LEDER
              </p>
              <div className="w-full h-px bg-white"></div>
              <p className="text-white text-xl my-10">Year: 2017</p>
              <p className="text-white text-xl mb-10">Mileage: 28 km</p>
              <div className="w-full h-px bg-white"></div>
              <p className="text-white text-2xl mt-10">€ 121,900</p>
            </div>
          </Link>
